...
router.patch("/user", authMiddleware, validate(updateProfileSchema), authController.updateUserProfile);
router.patch("/user/password", authMiddleware, validate(updatePasswordSchema), authController.updateUserPassword);
